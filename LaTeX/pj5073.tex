...
\fontsize{24pt}\baselineskip\selectfont 國立虎尾科技大學\\[15pt] %\\距離下方5pt
%{\ten{National Formosa University}}\\[20pt]
\makebox[1.2\width][s]
\fontsize{24pt}\baselineskip\selectfont 機械設計工程系暨精密機械工程科\\[15pt]
%{\ten{Department of Mechanical Design Engineering \& Department of Junior Precision Mechanical Engineering}}\\[20pt]
\makebox[1.5\width][s]
\fontsize{24pt}\baselineskip\selectfont 專題製作報告\\[120pt]
%{\ten{Project\quad Report}}\\[80pt]
\fontsize{24pt}\baselineskip\selectfont 網際內容管理系統\\
%{\ten{Application of Web-based Content Management Systems}\\[5pt]
\fontsize{24pt}\baselineskip\selectfont 在精密機械工程教學與研究上的應用\\[50pt]
%{\ten{in Teaching and Research of Precision Mechanical Engineering}}
\fontsize{18pt}\baselineskip\selectfont Application of Web-based Content Management Systems in Teaching and Research of Precision Mechanical Engineering
\end{center}
\begin{flushleft}
\begin{LARGE}
\vspace{5em}
