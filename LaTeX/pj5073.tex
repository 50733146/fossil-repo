...
%=------------------更改目錄內容-----------------------=%
\titlecontents{chapter}[2em]{}{\sectionef\fontsize{16pt}{3pt}\bfseries\makebox[2.5em][l]{第\CJKnumber{\thecontentslabel}章}}{}{\titlerule*[0.7pc]{.}\contentspage}
...
%\newpage
%\input{content.tex}
\addcontentsline{toc}{chapter}{\LARGE 摘要}
